  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
	    ...
	    <li class="nav-item">
        <a class="nav-link collapsed" href="resultview.php" >
          <i class="fas fa-chalkboard-teacher"></i>
...
<li class="nav-item">
        <a class="nav-link collapsed" href="subjectview.php" >
          <i class="fas fa-chalkboard-teacher"></i>
          <span>Subjects</span>
        </a>
		...
		<!-- Sidebar Toggle (Topbar) -->
		 ...
		 <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto pr-5 p-hide">
            ...
            <!-- Nav Item - Alerts -->
            <li class="nav-item ">
              <a class="nav-link " href="studentlogin.php">
                <i class="fas fa-home"><p> Home</p></i>
              </a>
              
            </li>
			<li class="nav-item">
              <a class="nav-link " href="studentprofview.php">
